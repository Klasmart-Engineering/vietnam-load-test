...
## Install Chrome
RUN wget -q https://dl.google.com/linux/chrome/deb/pool/main/g/google-chrome-stable/google-chrome-stable_101.0.4951.64-1_amd64.deb -P /tmp
RUN ${APT} install /tmp/google-chrome-stable_101.0.4951.64-1_amd64.deb
