...
RUN apt update
RUN apt-get -o=Dpkg::Use-Pty=0 -qq -y install npm curl vim wget libappindicator1 fonts-liberation
## Install Chrome
...
RUN apt-get -o=Dpkg::Use-Pty=0 -qq -y install xorg xvfb gtk2-engines-pixbuf dbus-x11 xfonts-base xfonts-100dpi xfonts-75dpi xfonts-cyrillic xfonts-scalable imagemagick x11-apps
